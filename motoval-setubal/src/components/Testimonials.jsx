    ...
    <section className="py-20 md:py-32 bg-[#0A0A0A]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedSection animation="fadeUp">
          <div
            className="relative bg-[#141414] rounded-2xl p-8 md:p-12 border border-[#2D2D2D]"
          ...
          >
            ...
            <div className="flex gap-1 mb-6">
              {[...Array(currentTestimonial.rating)].map((_, i) => (
                <Star
                  key={i}
                  className="w-5 h-5 fill-[#FBE013] text-[#FBE013]"
                />
              ))}
            </div>
            ...
            {/* Navigation */}
            <div className="flex items-center justify-between mt-8 pt-8 border-t border-[#2D2D2D]">
              {/* Dots */}
              ...
              <div className="flex gap-2">
                <button
                  onClick={prevSlide}
                  className="w-10 h-10 rounded-full border border-[#2D2D2D] flex items-center justify-center text-[#9CA3AF] hover:border-[#FBE013] hover:text-[#FBE013] transition-colors"
