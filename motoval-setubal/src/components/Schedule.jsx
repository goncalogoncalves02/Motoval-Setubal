    ...
    <section className="py-20 md:py-32 bg-[#141414]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedSection animation="fadeUp">
          <div className="bg-[#1A1A1A] rounded-2xl p-6 md:p-8 border border-[#2D2D2D]">
            {/* Table Header */}
            <div className="flex items-center gap-3 mb-6 pb-6 border-b border-[#2D2D2D]">
            ...
            {/* Note */}
            <div className="mt-6 pt-6 border-t border-[#2D2D2D] flex items-start gap-3">
