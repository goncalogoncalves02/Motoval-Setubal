...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 md:py-32 bg-[#141414]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <AnimatedSection animation="fadeUp">
            <div className="relative">
              ...
              {/* Decorative element */}
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#FBE013]/10 rounded-2xl -z-10" />
              <div className="absolute -top-6 -left-6 w-24 h-24 border-2 border-[#FBE013]/30 rounded-2xl -z-10" />
            </div>
          </AnimatedSection>
          ...
          <div>
            <AnimatedSection animation="fadeUp">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-8 font-[var(--font-heading)] leading-tight">
                {about.title}
              </h2>
            </AnimatedSection>
                ...
                return (
                  ...
                  >
                    <div className="bg-[#1A1A1A] rounded-xl p-6 border border-[#2D2D2D] hover:border-[#FBE013]/50 transition-colors duration-300">
                      <Icon className="w-8 h-8 text-[#FBE013] mb-4" />
