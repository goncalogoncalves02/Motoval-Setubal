        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <AnimatedSection animation="fadeUp" delay={0.4}>
              <div className="bg-[#141414] rounded-2xl p-6 border border-[#2D2D2D]">
                ...
                <div className="space-y-3">
                  {schedule.hours.map((item, index) => (
                    <div
                      key={index}
                      className="flex justify-between items-center py-2 px-3 rounded-lg hover:bg-[#2D2D2D]/50 transition-colors"
                    >
                ...
                <div className="mt-4 pt-4 border-t border-[#2D2D2D] flex items-start gap-3">
          ...
          <AnimatedSection animation="fadeUp" delay={0.2}>
            <div className="bg-[#141414] rounded-2xl overflow-hidden border border-[#2D2D2D] h-full min-h-[500px]">
              <iframe
