        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="space-y-6 sm:space-y-8">
                ...
                return (
                  ...
                  >
                    <a
                      ...
                      className="block bg-[#141414] rounded-xl p-4 sm:p-5 md:p-6 border border-[#2D2D2D] hover:border-[#FBE013] transition-all duration-300 h-full group"
                    >
            ...
            <AnimatedSection animation="fadeUp" delay={0.4}>
              <div className="bg-[#141414] rounded-2xl p-4 sm:p-5 md:p-6 border border-[#2D2D2D]">
                ...
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-[#2D2D2D] flex items-start gap-2 sm:gap-3">
          ...
          <AnimatedSection animation="fadeUp" delay={0.2}>
            <div className="bg-[#141414] rounded-2xl overflow-hidden border border-[#2D2D2D] h-full min-h-[300px] sm:min-h-[400px] lg:min-h-[500px]">
              <iframe
